...
exports.getinvoice = (req, res, next) => {
  ...
  Orders.findById(orderid).then((order) => {
    ...
    order.products.forEach((prod) => {
      ...
      pdfDoc
        .fontSize(14)
        .text("ACCOUNT COMPLETE GAMES" + "   " + prod.product.description);
      pdfDoc.text("-------------");
      pdfDoc.fontSize(14).text("STEAM ID" + "   " + prod.product.steamId);
      pdfDoc
        .fontSize(14)
        .text("STEAM PASSWORD" + "   " + prod.product.steampassword);
      pdfDoc.text("-------------");
    });
    pdfDoc.text("-----------------------");
