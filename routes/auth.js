...
router.post('/signup' , [body("name", 'Please enter atleast 4 character username').isLength({min:4}) , 
...
body("password" , 'Please enter with number and text and atleast 6 character').isLength({min : 6})
.isAlphanumeric().trim(), 
